        ...
        {packages.map((pkg) => (
          ...
          >
            ...
            <div className="mt-4 pt-4 border-t border-gray-100 flex items-center justify-between">
              ...
              {/* Tutors might later click to manage or view enrolled students per package */}
              <button
                className="px-4 py-2 rounded-xl border border-gray-200 text-sm font-bold text-gray-700 hover:bg-gray-50 transition"
              >
                View Details
              </button>
            </div>

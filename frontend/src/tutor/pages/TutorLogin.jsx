...
//             type="submit"
//             disabled={loading}
//             className="w-full bg-[#1e293b] text-white py-2 rounded-lg hover:bg-[#063F7C] transition disabled:opacity-50"
//           >
...
//           <Link to="/become-tutor" className="text-blue-600 hover:underline">
//             Apply here
//           </Link>
//         </p>
//       </div>

...
const StudentSidebar = ({ isOpen, setIsOpen }) => {
  // Students ke liye relevant menu items
  const menuItems = [
  ...
  return (
    <aside className={`
      fixed inset-y-0 left-0 z-50 w-72 bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 text-white 
      ...
      <div className="p-6">
        <div className="bg-white/5 rounded-3xl p-4 border border-white/10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <p className="text-sm font-bold truncate w-32">Rahul Sharma</p>
              <p className="text-[10px] text-white/50">Level 4 Learner</p>
            </div>
          </div>
          
          <button className="w-full flex items-center justify-center gap-2 py-2 rounded-xl bg-red-500/10 text-red-400 hover:bg-red-500 hover:text-white transition-all text-xs font-bold">

...
const Dashboard = () => {
  ...
  const stats = {
    ...
    hours: enrollments.length, // Estimate 2 hours per enrollment
      ...
      <main className="max-w-[1400px] mx-auto space-y-6 sm:space-y-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 px-4 sm:px-6">
          {statsConfig.map((s, i) => (
            ...
            >
              <div
                className={`w-10 h-10 sm:w-12 sm:h-12 ${s.bg} rounded-xl sm:rounded-2xl flex items-center justify-center mb-3 sm:mb-4`}
              >
                {s.icon}
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 px-4 sm:px-6">
          ...
          <div className="lg:col-span-6   w-full  bg-white rounded-[1.5rem] sm:rounded-[2rem] border border-slate-100 p-5 sm:p-8 shadow-sm">
            ...
            {loading ? (
              ...
              <div
                className="h-48 sm:h-64 w-full bg-slate-50 rounded-2xl border-2 border-dashed

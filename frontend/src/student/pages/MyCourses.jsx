...
import { PlayCircle, CheckCircle, Clock, BookOpen, Search, Filter, LayoutDashboard } from 'lucide-react';
...
const MyCourses = () => {
  ...
  <div className="flex flex-col items-center justify-center py-20 px-4 textcenter bg-white rounded-[2rem] border-2 border-dashed border-gray-100">
  <div className="w-20 h-20 bg-blue-50 rounded-3xl flex items-center justify-center mb-6">
    <LayoutDashboard className="text-[#0852A1]" size={40} />
  </div>

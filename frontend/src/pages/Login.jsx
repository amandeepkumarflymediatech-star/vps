...
//               className="w-full mt-1 px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#0852A1] outline-none pr-10"
//             />
//             <button
//               type="button"
...
//               <input type="checkbox" className="accent-[#0852A1]" />
//               Remember me
//             </label>
//             <Link to="/forgot-password" className="text-[#0852A1] hover:underline">
//               Forgot password?
//             </Link>
//           </div>
...
//             type="submit"
//             disabled={loading}
//             className="w-full bg-[#0852A1] text-white py-2 rounded-lg font-semibold hover:bg-[#063F7C] transition"
//           >

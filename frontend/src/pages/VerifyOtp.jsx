...
const VerifyOtp = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F8F3F3]">
      <form onSubmit={handleVerify} className="bg-white p-8 rounded-lg w-full max-w-md">
        ...
        <input
          ...
          value={otp}
          onChange={(e) => setOtp(e.target.value.replace(/\D/g, ""))}
          className="w-full text-center tracking-widest border p-3 rounded-lg"
          placeholder="Enter 6 digit OTP"
        />

        <button
          type="submit"
          className="w-full mt-4 bg-[#0852A1] text-white py-2 rounded-lg"
        >
          Verify OTP
        </button>
      </form>

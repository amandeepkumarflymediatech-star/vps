...
//           {/* ===== LEFT GLASS CONTENT ===== */}
//           <div className="backdrop-blur-md bg-white/80 rounded-2xl p-8 shadow-xl max-w-xl">
...
//               The English Raj offers personalized one-on-one English learning
//               with expert tutors. Whether you’re preparing for interviews,
//               office meetings, or public speaking, learn at your own pace,
//               choose flexible time slots, and build real-life confidence through
//               practical conversations that accelerate your growth.
//             </p>

//             <button className="mt-6 bg-[#0852A1] hover:bg-[#063F7C] text-white px-6 py-3 rounded-full text-sm font-medium flex items-center gap-2">
//               BOOK NOW →
//             </button>
//           </div>

//           {/* ===== RIGHT PRICING FLOATING CARDS ===== */}
...
//             { value: "500+", label: "Verified Expert Tutors", icon: "👥" },
//             { value: "95%", label: "Learner Satisfaction Rate", icon: "🎓" },
